...
export const metadata = {
  title: "PixelNFT - AI-Generated Pixel Art NFTs on Filecoin Calibration",
  description: "Create, mint, and trade pixel art NFTs using AI on the Filecoin Calibration network",
  icons: {
    icon: "/favicon.ico",
  },
}
